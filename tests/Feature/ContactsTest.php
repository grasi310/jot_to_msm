...
class ContactsTest extends TestCase
{
    ...
    public function a_list_of_contacts_can_be_fetched_for_the_authenticated_user()
    {
        ...
        $anotherUser = factory(Contact::class)->create(['user_id' => $anotherUser->id]);
    ...
    public function an_authenticated_user_can_add_a_contact()
    {
        ...
        $this->assertEquals('03/10/1991', $contact->birthday->format('d/m/Y'));
    ...
    public function birthdays_are_properly_stored()
    {
        ...
        $this->assertEquals('03/10/1991', Contact::first()->birthday->format('d/m/Y'));
    }
